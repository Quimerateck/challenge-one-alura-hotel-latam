...
public class Login extends JFrame {
	...
	private void iniciarLogin() {
		...
		if(LoginController.checkUsername(usuario)){

			System.out.println(LoginController.checkUsername(usuario));

			if (LoginController.checkPassword(usuario, password)){
				
				System.out.println(LoginController.checkPassword(usuario, password));
