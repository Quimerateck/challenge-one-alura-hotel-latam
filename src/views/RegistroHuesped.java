...
public class RegistroHuesped extends JFrame {
	...
	public RegistroHuesped() {
		...
		txtNreserva.setText(ReservasController.ultimoID());
		...
		btnguardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				try{
					registrarHuesped();
					JOptionPane.showMessageDialog(null, "La reserva y su huesped han sido guardados con exito!");
					MenuUsuario menu = new MenuUsuario();
					menu.setVisible(true);
					dispose();
					
				}catch(NullPointerException npe){
					JOptionPane.showMessageDialog(null, "No deben de quedar campos vacios!");
					throw new RuntimeException(npe);
				}
				catch(Exception ex){
					JOptionPane.showMessageDialog(null, "Hubo un error al ingresar los datos, vuelva a intentarlo mas tarde");
	...
	private void registrarHuesped(){
		...
		nuevoHuesped.setFechaNacimiento(txtFechaN.getDateEditor().getDate());
		nuevoHuesped.setNacionalidad(txtNacionalidad.getSelectedItem().toString());
		nuevoHuesped.setTelefono(txtTelefono.getText());
		nuevoHuesped.setIdReserva(Integer.parseInt(txtNreserva.getText()));
