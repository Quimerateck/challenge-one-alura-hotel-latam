...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		...
		txtFechaEntrada.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {		
					...
					txtValor.setText(utils.Calcular.calcularValorReserva(txtFechaEntrada, txtFechaSalida));
				}
			}
		});
		...
		btnsiguiente.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				if (ReservasView.txtFechaEntrada.getDate() != null && ReservasView.txtFechaSalida.getDate() != null) {		
					//TODO: crear una clase en UTils para almacenar los valores de HUESPED y RESERVA
					utils.Reservar.guardarReserva(txtFechaEntrada, txtFechaSalida, txtFormaPago, txtValor);
